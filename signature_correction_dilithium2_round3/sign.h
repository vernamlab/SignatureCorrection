...
//////////////////////////////////////////////////////
#define crypto_sign_verify_signature_correction DILITHIUM_NAMESPACE(_verify_signature_correction)
int crypto_sign_verify_signature_correction(const uint8_t *sig, size_t siglen,
                       const uint8_t *m, size_t mlen,
                       const uint8_t *pk);
//////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////
#define crypto_sign_open_signature_correction DILITHIUM_NAMESPACE(_open_signature_correction)
int crypto_sign_open_signature_correction(uint8_t *m, size_t *mlen,
                     const uint8_t *sm, size_t smlen,
                     const uint8_t *pk);
/////////////////////////////////////////////////////
